        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Context = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CharKey = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false),
                    Context = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    IsCorrectAnswer = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    QuestionItemId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
